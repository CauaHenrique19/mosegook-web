        ...
        if(avaliationId !== 0){
            ...
            .then(res => {
                if(res.data.avaliation){
                    ...
                    setLoading(false)
                    console.log(avaliationDetailed.coments)
                }
            })
        ...
        <div className="avaliation-detail-container">
            ...
            <div className="avaliation-container">
                ...
                <div className="avaliations-coments-container">
                    {
                        avaliationDetailed.coments && avaliationDetailed.coments.length > 0 && 
                    ...
                    <div className="coments">
                        {
                            avaliationDetailed.coments && avaliationDetailed.coments.length > 0 && avaliationDetailed.coments.map(coment => (
