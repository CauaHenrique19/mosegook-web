                ...
                <h1>Mídia Avaliada</h1>
                {
                    ...
                    <div className="media">
                        <div className="media-image-container">
                            <img src={avaliationDetailed.avaliation.url_poster} alt="" />
                        </div>
                        <div className="media-info-container">
                            <h3>{avaliationDetailed.avaliation.media_name}</h3>
                        </div>
                    </div>
                }
                <h1>Gêneros</h1>
                <div className="genders-avaliation-container">
                    {
                        avaliationDetailed.genders && avaliationDetailed.genders.map(gender => (
                            <div key={gender.id} style={{ backgroundColor: gender.color }} className="gender-avaliation-container">{gender.name}</div>
                        ))
                    }
                </div>
            </div>
